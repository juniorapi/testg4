...
function updateCalculator(targetPercent) {
    ...
    const complexityValue = document.querySelector('.calc-option:nth-child(5) .calc-value');
    const winsValue = document.querySelector('.calc-option:nth-child(6) .calc-value');
    const streamValue = document.querySelector('.calc-option:nth-child(7) .calc-value');
    const timeframeValue = document.querySelector('.calc-option:nth-child(8) .calc-value');
